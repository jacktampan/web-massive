        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 px-4 py-3 justify-center sm:flex sm:flex-row-reverse sm:px-6">
              <a
                href="/register"
                className="inline-flex w-full justify-center rounded-md bg-custom-color px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 sm:ml-3 sm:w-auto"
              >
                Pencari Kost
              </a>
              <a
                href="/admin/register"
                className="inline-flex w-full justify-center rounded-md bg-custom-orange px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 sm:mt-0 sm:w-auto mt-3"
                onClick={onClose}
              >
                Pemilik Kost
              </a>
