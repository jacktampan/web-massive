    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="bg-white p-8 rounded shadow-lg w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">Please enter your email, we'll send you an OTP on your email address</p>
        </div>
        <form>
          <div className="mb-4">
        ...
        <div className="text-center p-6">
          <p className="text-gray-600">Don't have an account? <a href="/registerform" className="text-orange-500 hover:underline">Sign Up</a></p>
