...
const products = [
  {
    ...
    name: "Product One",
    description:
      "This is a description of the first product. It's a great choice for anyone looking for quality and performance.",
    price: "$199",
  ...
  },
  {
    ...
    name: "Product Two",
    description:
      "Explore the features of our second product. It offers exceptional value and versatility.",
    price: "$299",
    imageUrl: "https://placehold.co/100x50",
  },
  {
    ...
    name: "Product Three",
    description:
      "Our third product is perfect for those who appreciate top-notch quality and innovation.",
    price: "$399",
    imageUrl: "https://placehold.co/100x50",
  },
];
